...
class SpecificMerchantView extends StatefulWidget {
  ...
  @override
  _SpecificMerchantViewState createState() =>
      _SpecificMerchantViewState(paginateTotal);
}

class _SpecificMerchantViewState extends State<SpecificMerchantView> {
  ...
  _SpecificMerchantViewState(this.paginateTotal);
                      ...
                      child: Stack(
                        children: <Widget>[
                          Container(
                            ...
                            child: Hero(
                              tag: widget.homeBannerModel.banner,
                              child: CachedNetworkImage(
                                imageUrl: widget.homeBannerModel.banner,
                                fit: BoxFit.fitWidth,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                widget.homeBannerModel.title != null &&
                                        widget.homeBannerModel.title.length > 2
                                    ? Container(
                                ...
                                widget.homeBannerModel.subTitle != null &&
                                        widget.homeBannerModel.subTitle.length >
                                            2
                                    ? Container(
                                        padding: EdgeInsets.all(2.5),
                                        decoration: BoxDecoration(
                                        ...
                                        child: Text(
                                          lang.api(
                                              widget.homeBannerModel.subTitle),
                                          style: TextStyle(
